/* $Id: tpmodule.c 92 2017-10-10 08:47:11Z Klegin $ */
/******************************************************************************
*******************************************************************************
**                                                                           **
**                                                                           **
	...
	if (device_class != NULL)
	{
        ...
        class_device_create(device_class, dev_handle->device, NULL, (char*)name);
		    ...
		    class_device_create(device_class, NULL, dev_handle->device, NULL, (char*)name);
                ...
                /* Kernel 2.6.19 - 2.6.24 */
                class_device_create(device_class, NULL, dev_handle->device, NULL, name); 
                #else
                    #if LINUX_VERSION_CODE < KERNEL_VERSION(2,6,27)
                    /* Kernel 2.6.25 - 2.6.26 */
                    device_create(device_class, NULL, dev_handle->device, name); 
                    #else 
                    /* Kernel >= 2.6.27 */
                    device_create(device_class, NULL, dev_handle->device, NULL, name);
                    #endif
                #endif
            #endif
        #endif
...
/* BEGIN SYSFS(UDEV) support */
	...
	if (device_class != NULL)
	{
        ...
        #else
        /* Kernel >= 2.6.25 */
        device_destroy(device_class, dev->device); 
        #endif
	}
#endif
#endif
...
*/
TPMODULE_STORAGE_CLASS int tpmodule_request_irq(unsigned int irq, void* handler, const char *devname, void *dev_id)
{
...
*/
TPMODULE_STORAGE_CLASS int tpmodule_pci_register_driver( struct pci_driver *driver )
{
#if LINUX_VERSION_CODE < KERNEL_VERSION(2,6,22)
...
*/
TPMODULE_STORAGE_CLASS void tpmodule_pci_unregister_driver( struct pci_driver *driver )
{
...
*/
TPMODULE_STORAGE_CLASS void tpmodule_init_bottomhalf( tpmodule_bhtask_t* bh_task, void* handler, void* arg )
{
...
*/
TPMODULE_STORAGE_CLASS void tpmodule_schedule_bottomhalf( tpmodule_bhtask_t* bh_task )
{
#if LINUX_VERSION_CODE >= KERNEL_VERSION(2,6,0)
		schedule_work(bh_task);
#else
        /* this would result in the bottom half to be executed on interrupt level! */
        /*
		queue_task(bh_task, &tq_immediate);
		mark_bh(IMMEDIATE_BH);
        */
        schedule_task( bh_task );
#endif
}
