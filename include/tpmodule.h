/* $Id: tpmodule.h 92 2017-10-10 08:47:11Z Klegin $ */
/******************************************************************************
*******************************************************************************
**                                                                           **
**                                                                           **
...
*/
TPMODULE_STORAGE_CLASS int tpmodule_request_irq(unsigned int irq, void* handler, const char *devname, void *dev_id) __attribute__ ((unused));

/*
** PCI driver register abstraction prototype
*/
TPMODULE_STORAGE_CLASS int tpmodule_pci_register_driver( struct pci_driver *driver ) __attribute__ ((unused));
TPMODULE_STORAGE_CLASS void tpmodule_pci_unregister_driver( struct pci_driver *driver ) __attribute__ ((unused));
...
#endif
TPMODULE_STORAGE_CLASS void tpmodule_init_bottomhalf( tpmodule_bhtask_t* bh_task, void* handler, void* arg ) __attribute__ ((unused));
TPMODULE_STORAGE_CLASS void tpmodule_schedule_bottomhalf( tpmodule_bhtask_t* bh_task ) __attribute__ ((unused));
